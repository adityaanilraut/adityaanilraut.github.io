        ...
        <div className="contact-layout">
          <div>
            ...
            <p className="contact-text">
              I'm always open to discussing new opportunities, collaborating on open-source AI projects, 
              or simply connecting to chat about LLM orchestrations. Reach out via any of the channels below!
            </p>
          </div>

          <div className="contact-cards-grid">
            {contacts.map((contact, index) => (
              <div key={index} className="contact-details-card">
